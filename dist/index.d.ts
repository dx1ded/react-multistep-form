...
declare function Steps({ children, onSubmit, hasProgress, hasNavigation, primaryColor, progressColor, navigationColor, item, defaultStep, defaultData, defaultSetPrevStep, defaultSetNextStep, defaultSetData }: StepsProps): React.JSX.Element;

declare function MergeSteps({ children, onSubmit, hasProgress, hasNavigation, primaryColor, progressColor, navigationColor }: StepsProps): React.JSX.Element;

export { MergeSteps, type RenderProps, type StepMiddleware, type StepProps, Steps, type StepsProps };
