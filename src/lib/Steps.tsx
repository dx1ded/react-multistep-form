import React, {useState, Children, ReactElement, useRef, cloneElement} from "react"
...
export type StepElement = RenderProps & {
  title: string,
  noProgress?: boolean,
...
export function Steps({
  ...
  const invokedChildren = Children.toArray(
    children({
      ...
      setData,
      setButtonsDisabled,
      setPrevStep: () => setStep((prev) => prev - 1),
      setNextStep
  ...
  const currentElement = invokedChildren[step]
